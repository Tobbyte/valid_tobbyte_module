...
def validate_fn(
    ...
    *,
    ...
    Provides an wrapped input function that continuously
    prompts the user until a valid value from `valid_inputs` is
...
if __name__ == "__main__":
    inp = validate_fn([1, 2, "a", TypeLengthConstraint(4, float)], "do inp: ")
    print(inp, type(inp))
